...
public class srfi69 extends ModuleBody {
    ...
    static final SimpleSymbol Lit3 = ((SimpleSymbol) new SimpleSymbol(SettingsJsonConstants.ICON_HASH_KEY).readResolve());
        ...
        switch (moduleMethod.selector) {
            ...
            case 5:
                try {
                    ...
                    throw new WrongType(e222, SettingsJsonConstants.ICON_HASH_KEY, 2, obj2);
                }
            case 7:
                try {
