...
public class testing extends ModuleBody {
    ...
    public class frame1 extends ModuleBody {
        ...
        Object lambda9() {
            return ((Procedure) testing.test$Mnrunner$Mncurrent).apply1(this.f103r);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) {
            this.f104i = AddOp.$Pl.apply2(this.f104i, testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f104i, this.f105n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f104i, AddOp.$Pl.apply2(this.f105n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            frame.f106p = lists.assq(pname, alist);
            if (frame.f106p != Boolean.FALSE) {
                try {
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        Object obj = frame1.f103r;
        try {
            return procedure.apply2(testRunnerOnFinal((test$Mnrunner) obj), frame1.f103r);
