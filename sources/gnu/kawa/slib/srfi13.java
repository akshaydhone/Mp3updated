        ...
        switch (moduleMethod.selector) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj2 = objArr[5];
                            try {
                                return Integer.valueOf($PcStringPrefixLengthCi(obj, length, intValue, obj4, intValue2, ((Number) obj2).intValue()));
                            } catch (ClassCastException e) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj2 = objArr[5];
                            try {
                                return Integer.valueOf($PcStringSuffixLengthCi(obj, length, intValue, obj4, intValue2, ((Number) obj2).intValue()));
                            } catch (ClassCastException e2222) {
            ...
            case 237:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompare$V(obj, obj7, obj3, obj4, obj5, objArr3);
                    }
            ...
            case 238:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompareCi$V(obj, obj7, obj3, obj4, obj5, objArr3);
                    }
                    objArr3[length2] = objArr[length2 + 5];
                }
            case LispEscapeFormat.ESCAPE_NORMAL /*241*/:
