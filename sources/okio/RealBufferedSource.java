...
final class RealBufferedSource implements BufferedSource {
    ...
    class C05481 extends InputStream {
        C05481() {
        }
    ...
    public int readUtf8CodePoint() throws IOException {
        ...
        if ((b0 & 224) == FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE) {
            require(2);
        } else if ((b0 & 240) == 224) {
            require(3);
        } else if ((b0 & 248) == 240) {
    ...
    public long readDecimalLong() throws IOException {
        ...
        while (request((long) (pos + 1))) {
            ...
            if ((b < Opcode.MOVE8_8 || b > Opcode.MOVE32_16) && !(pos == 0 && b == Opcode.RL16)) {
                if (pos == 0) {
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        for (int pos = 0; request((long) (pos + 1)); pos++) {
            byte b = this.buffer.getByte((long) pos);
            if ((b < Opcode.MOVE8_8 || b > Opcode.MOVE32_16) && ((b < Opcode.PORT_CNV_OUTPUT || b > Opcode.JR_LT32) && (b < Opcode.JR_FALSE || b > Opcode.CP_LT32))) {
                if (pos == 0) {
