...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    class C05451 extends OutputStream {
        C05451() {
        }
    ...
    class C05462 extends InputStream {
        C05462() {
        }
    ...
    public long readHexadecimalUnsignedLong() {
        ...
        do {
            ...
            while (pos < limit) {
                int digit;
                int b = data[pos];
                if (b >= Opcode.MOVE8_8 && b <= Opcode.MOVE32_16) {
                    digit = b - 48;
                } else if (b >= Opcode.PORT_CNV_OUTPUT && b <= Opcode.JR_LT32) {
                    digit = (b - 97) + 10;
                } else if (b < Opcode.JR_FALSE || b > Opcode.CP_LT32) {
                    if (seen != 0) {
                        done = true;
                        if (pos != limit) {
                            this.head = segment.pop();
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            byteCount = 1;
            min = 0;
        } else if ((b0 & 224) == FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE) {
            codePoint = b0 & 31;
            byteCount = 2;
            min = 128;
        } else if ((b0 & 240) == 224) {
        ...
        while (i < byteCount) {
            ...
            if ((b & FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE) == 128) {
        ...
        if (string == null) {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    writeByte((c >> 6) | FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
                    writeByte((c & 63) | 128);
                    i2 = i + 1;
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            writeByte((codePoint >> 6) | FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
            writeByte((codePoint & 63) | 128);
