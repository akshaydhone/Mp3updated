...
public class DeviceInfo {
    ...
    private class CachedInfo {
        ...
        private String getAndCacheAmazonAdvertisingId() {
            ...
            if (Secure.getInt(cr, DeviceInfo.SETTING_LIMIT_AD_TRACKING, 0) != 1) {
                z = false;
            }
            this.limitAdTrackingEnabled = z;
            this.advertisingId = Secure.getString(cr, DeviceInfo.SETTING_ADVERTISING_ID);
        ...
        private String getAndCacheGoogleAdvertisingId() {
            ...
            try {
                ...
                AmplitudeLog.getLogger().m11w(DeviceInfo.TAG, "Google Play Services SDK not found!");
            } catch (InvocationTargetException e2) {
                AmplitudeLog.getLogger().m11w(DeviceInfo.TAG, "Google Play Services not available");
            } catch (Exception e3) {
                AmplitudeLog.getLogger().m6e(DeviceInfo.TAG, "Encountered an error connecting to Google Play Services", e3);
            }
            return this.advertisingId;
        }
        ...
        private boolean checkGPSEnabled() {
            try {
                ...
                AmplitudeLog.getLogger().m11w(DeviceInfo.TAG, "Google Play Services Util not found!");
                return false;
                ...
                AmplitudeLog.getLogger().m11w(DeviceInfo.TAG, "Error when checking for Google Play Services: " + e6);
                return false;
            }
        }
    }
