...
public final class MD5 extends MessageDigest implements Cloneable {
    ...
    public MD5() {
        super(CommonUtils.MD5_INSTANCE);
        init();
    }
    ...
    public void engineUpdate(byte[] input, int offset, int length) {
        ...
        while (length >= 512) {
            ...
            engineUpdate(input, offset + FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
            engineUpdate(input, offset + 256);
            engineUpdate(input, offset + ScreenDensityUtil.DEFAULT_NORMAL_SHORT_DIMENSION);
