...
class QueueFileLogStore implements FileLogStore {
    ...
    public ByteString getLogAsByteString() {
        ...
        try {
            ...
            Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "Could not open log file: " + this.workingFile, e);
            }
        }
    }
    ...
    private void doWriteToLog(long timestamp, String msg) {
        if (this.logFile != null) {
            ...
            try {
                ...
                Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "There was a problem writing to the Crashlytics log.", e);
            }
        }
    }
}
