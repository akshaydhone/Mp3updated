    ...
    public void writeUserData(String sessionId, UserMetaData data) {
        ...
        try {
            ...
            try {
                ...
                writer = writer2;
                try {
                    Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "Error serializing user metadata.", e);
    ...
    public UserMetaData readUserData(String sessionId) {
        ...
        try {
            ...
            try {
                ...
                is = is2;
                try {
                    Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String sessionId, Map<String, String> keyData) {
        ...
        try {
            ...
            try {
                ...
                writer = writer2;
                try {
                    Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "Error serializing key/value metadata.", e);
