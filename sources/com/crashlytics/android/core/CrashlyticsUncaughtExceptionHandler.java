...
class CrashlyticsUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        try {
            ...
            Fabric.getLogger().mo1332e(CrashlyticsCore.TAG, "An error occurred in the uncaught exception handler", e);
        } finally {
            Fabric.getLogger().mo1329d(CrashlyticsCore.TAG, "Crashlytics completed exception processing. Invoking default exception handler.");
