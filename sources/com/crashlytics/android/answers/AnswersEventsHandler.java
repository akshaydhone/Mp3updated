...
class AnswersEventsHandler implements EventsStorageListener {
    ...
    class C02252 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo1332e(Answers.TAG, "Failed to disable events", e);
            }
        }
    }
    ...
    class C02263 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo1332e(Answers.TAG, "Failed to send events files", e);
            }
        }
    }
    ...
    class C02274 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo1332e(Answers.TAG, "Failed to enable events", e);
            }
        }
    }
    ...
    class C02285 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo1332e(Answers.TAG, "Failed to flush events", e);
            }
        }
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo1332e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
    ...
    public void disable() {
        executeAsync(new C02252());
    }

    public void onRollOver(String rolledOverFile) {
        executeAsync(new C02263());
    }

    public void enable() {
        executeAsync(new C02274());
    }

    public void flushEvents() {
        executeAsync(new C02285());
    }
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo1332e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (sync) {
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo1332e(Answers.TAG, "Failed to run events task", e);
        }
    }
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo1332e(Answers.TAG, "Failed to submit events task", e);
        }
    }
}
