...
class BackgroundManager {
    ...
    public void onActivityPaused() {
        if (this.flushOnBackground && !this.inBackground) {
            ...
            try {
                this.backgroundFutureRef.compareAndSet(null, this.executorService.schedule(new C02301(), 5000, TimeUnit.MILLISECONDS));
            } catch (RejectedExecutionException e) {
                Fabric.getLogger().mo1330d(Answers.TAG, "Failed to schedule background detector", e);
            }
        }
    }
}
