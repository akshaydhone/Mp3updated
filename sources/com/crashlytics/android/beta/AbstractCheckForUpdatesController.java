...
abstract class AbstractCheckForUpdatesController implements UpdatesController {
    ...
    protected void checkForUpdates() {
        ...
        Fabric.getLogger().mo1329d(Beta.TAG, "Check for updates delay: " + updateCheckDelayMillis);
        Fabric.getLogger().mo1329d(Beta.TAG, "Check for updates last check time: " + getLastCheckTimeMillis());
        long nextCheckTimeMillis = getLastCheckTimeMillis() + updateCheckDelayMillis;
        Fabric.getLogger().mo1329d(Beta.TAG, "Check for updates current time: " + currentTimeMillis + ", next check time: " + nextCheckTimeMillis);
        if (currentTimeMillis >= nextCheckTimeMillis) {
            ...
            Fabric.getLogger().mo1329d(Beta.TAG, "Check for updates next check time was not passed");
        }
    }

    private void performUpdateCheck() {
        Fabric.getLogger().mo1329d(Beta.TAG, "Performing update check");
