        ...
        try {
            ...
            if (zis != null) {
                try {
                    ...
                    Fabric.getLogger().mo1332e(Beta.TAG, "Failed to close the APK file", e);
                }
            }
        } catch (NameNotFoundException e2) {
            Fabric.getLogger().mo1329d(Beta.TAG, "Beta by Crashlytics app is not installed");
            if (zis != null) {
                try {
                    zis.close();
                } catch (IOException e3) {
                    Fabric.getLogger().mo1332e(Beta.TAG, "Failed to close the APK file", e3);
                }
            }
        } catch (FileNotFoundException e4) {
            Fabric.getLogger().mo1332e(Beta.TAG, "Failed to find the APK file", e4);
            if (zis != null) {
                try {
                    zis.close();
                } catch (IOException e32) {
                    Fabric.getLogger().mo1332e(Beta.TAG, "Failed to close the APK file", e32);
                }
            }
        } catch (IOException e322) {
            Fabric.getLogger().mo1332e(Beta.TAG, "Failed to read the APK file", e322);
            if (zis != null) {
                try {
                    zis.close();
                } catch (IOException e3222) {
                    Fabric.getLogger().mo1332e(Beta.TAG, "Failed to close the APK file", e3222);
                }
            }
        } catch (Throwable th) {
            if (zis != null) {
                try {
                    ...
                    Fabric.getLogger().mo1332e(Beta.TAG, "Failed to close the APK file", e32222);
                }
            }
        }
        Fabric.getLogger().mo1329d(Beta.TAG, "Beta device token load took " + (((double) (System.nanoTime() - start)) / 1000000.0d) + "ms");
        return token;
    }
