...
public class PropertyTypeConstants {
    ...
    public static final String PROPERTY_TYPE_CANVAS = "Canvas";
    ...
    public static final String PROPERTY_TYPE_FAB_BUTTON_SIZE = "fab_button_size";
    ...
    public static final String PROPERTY_TYPE_SPINNER_MODE = "spinner_mode";
