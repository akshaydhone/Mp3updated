...
public class YaVersion {
    ...
    public static final String[] ACCEPTABLE_COMPANIONS = new String[]{"4.01", PREFERRED_COMPANION, "4.03"};
    public static final String ACCEPTABLE_COMPANION_PACKAGE = "com.thunkable.appinventor.aicompanion3";
    public static final int ACTIVITYSTARTER_COMPONENT_VERSION = 6;
    public static final int ADMOB_BANNER_COMPONENT_VERSION = 3;
    public static final int ADMOB_INTERSTITIAL_COMPONENT_VERSION = 3;
    ...
    public static final int CLOUDSTITCH_COMPONENT_VERSION = 1;
    ...
    public static final int GOOGLE_MAP_COMPONENT_VERSION = 3;
    ...
    public static final int MICROSOFTCOMPUTERVISIONAPI_COMPONENT_VERSION = 1;
    public static final int MICROSOFTEMOTIONAPI_COMPONENT_VERSION = 1;
    ...
    public static final int ONESIGNAL_COMPONENT_VERSION = 2;
    ...
    public static final String PREFERRED_COMPANION = "4.02";
    public static final int PROXIMITYSENSOR_COMPONENT_VERSION = 1;
    public static final int RECTANGLE_COMPONENT_VERSION = 1;
    public static final String RENDEZVOUS_SERVER = "rendezvous.thunkable.com";
