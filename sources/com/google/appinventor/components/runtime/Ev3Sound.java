...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to sound functionalities on LEGO MINDSTORMS EV3 robot.", docUri = "iot/lego.html#ev3-sound-sensor", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
...
public class Ev3Sound extends LegoMindstormsEv3Base {
    ...
    public void PlayTone(int volume, int frequency, int milliseconds) {
        ...
        if (volume < 0 || volume > 100 || frequency < 250 || frequency > AbstractSpiCall.DEFAULT_TIMEOUT || milliseconds < 0 || milliseconds > SupportMenu.USER_MASK) {
