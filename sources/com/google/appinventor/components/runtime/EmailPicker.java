...
public class EmailPicker extends TextBoxBase {
    ...
    class C06091 implements PermissionResultHandler {
        C06091() {
        }
    ...
    public void Initialize() {
        this.container.$form().askPermission("android.permission.READ_CONTACTS", new C06091());
    }
