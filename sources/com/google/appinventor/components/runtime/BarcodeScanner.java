...
@DesignerComponent(category = ComponentCategory.SENSORS, description = "Component for using the Barcode Scanner to read a barcode", docUri = "sensors/barcode-scanner", iconName = "images/barcodeScanner.png", nonVisible = true, version = 2)
...
public class BarcodeScanner extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C06031 implements PermissionResultHandler {
        C06031() {
        }
    ...
    public void DoScan() {
        ...
        if (!this.useExternalScanner && SdkLevel.getLevel() >= 5) {
            if (this.havePermission) {
                ...
                this.container.$form().askPermission("android.permission.CAMERA", new C06031());
                return;
            }
        }
