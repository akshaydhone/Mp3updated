...
@DesignerComponent(category = ComponentCategory.MEDIA, description = "<p>Multimedia component that records audio.</p>", docUri = "voice/sound-recorder", iconName = "images/soundRecorder.png", nonVisible = true, version = 2)
@SimpleObject
    ...
    public void Start() {
        if (!this.havePermission) {
            ...
            this.form.runOnUiThread(new Runnable() {
                ...
                class C06291 implements PermissionResultHandler {
                    C06291() {
                    }
                ...
                public void run() {
                    SoundRecorder.this.form.askPermission("android.permission.RECORD_AUDIO", new C06291());
                }
            });
