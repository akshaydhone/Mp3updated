...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a low-level interface to a LEGO MINDSTORMS NXT robot, with functions to send NXT Direct Commands.", docUri = "iot/lego.html#nxt-direct-commands", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
