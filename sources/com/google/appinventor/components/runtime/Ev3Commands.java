...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a low-level interface to a LEGO MINDSTORMS EV3 robot, with functions to send system or direct commands to EV3 robots.", docUri = "iot/lego.html#ev3-commands", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
