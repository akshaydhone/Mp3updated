    ...
    public void RecordVideo() {
        ...
        if (!this.havePermission) {
            ...
            this.form.runOnUiThread(new Runnable() {
                ...
                class C06041 implements PermissionResultHandler {
                    C06041() {
                    }
                ...
                public void run() {
                    Camcorder.this.form.askPermission("android.permission.CAMERA", new C06041());
                }
            });
