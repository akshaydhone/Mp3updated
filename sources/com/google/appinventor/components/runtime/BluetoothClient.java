...
@SimpleObject
@DesignerComponent(category = ComponentCategory.CONNECTIVITY, description = "Bluetooth client component", docUri = "iot/bluetooth", iconName = "images/bluetooth.png", nonVisible = true, version = 5)
