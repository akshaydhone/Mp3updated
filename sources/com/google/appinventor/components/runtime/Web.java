...
@DesignerComponent(category = ComponentCategory.CONNECTIVITY, description = "Non-visible component that provides functions for HTTP GET, POST, PUT, and DELETE requests.", docUri = "storage/web", iconName = "images/web.png", nonVisible = true, version = 5)
...
public class Web extends AndroidNonvisibleComponent implements Component {
    ...
    public void Get() {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        Web.this.performRequest(webProps, null, null, HttpRequest.METHOD_GET);
    ...
    public void PostText(String text) {
        requestTextImpl(text, "UTF-8", "PostText", HttpRequest.METHOD_POST);
    }
    ...
    public void PostTextWithEncoding(String text, String encoding) {
        requestTextImpl(text, encoding, "PostTextWithEncoding", HttpRequest.METHOD_POST);
    }
    ...
    public void PostFile(final String path) {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        Web.this.performRequest(webProps, null, path, HttpRequest.METHOD_POST);
                    } catch (PermissionException e) {
    ...
    public void PutText(String text) {
        requestTextImpl(text, "UTF-8", "PutText", HttpRequest.METHOD_PUT);
    }

    @SimpleFunction(description = "Performs an HTTP PUT request using the Url property and the specified text.<br>The characters of the text are encoded using the given encoding.<br>If the SaveResponse property is true, the response will be saved in a file and the GotFile event will be triggered. The ResponseFileName property can be used to specify the name of the file.<br>If the SaveResponse property is false, the GotText event will be triggered.")
    public void PutTextWithEncoding(String text, String encoding) {
        requestTextImpl(text, encoding, "PutTextWithEncoding", HttpRequest.METHOD_PUT);
    }
    ...
    public void PutFile(final String path) {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        Web.this.performRequest(webProps, null, path, HttpRequest.METHOD_PUT);
                    } catch (PermissionException e) {
    ...
    public void Delete() {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        Web.this.performRequest(webProps, null, null, HttpRequest.METHOD_DELETE);
                    } catch (PermissionException e) {
    ...
    private static HttpURLConnection openConnection(CapturedProperties webProps, String httpVerb) throws IOException, ClassCastException, ProtocolException {
        ...
        if (httpVerb.equals(HttpRequest.METHOD_PUT) || httpVerb.equals(HttpRequest.METHOD_DELETE)) {
