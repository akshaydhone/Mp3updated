...
@SimpleObject
@DesignerComponent(category = ComponentCategory.INTERNAL, description = "Circle", version = 1)
public class Circle extends PolygonBase implements MapCircle {
    private static final MapFeatureVisitor<Double> distanceComputation = new C06071();
    ...
    static class C06071 implements MapFeatureVisitor<Double> {
        C06071() {
        }
