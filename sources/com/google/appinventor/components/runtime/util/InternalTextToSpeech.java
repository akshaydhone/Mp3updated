...
public class InternalTextToSpeech implements ITextToSpeech {
    ...
    class C04791 implements OnInitListener {
        C04791() {
        }
    ...
    class C04812 implements OnUtteranceCompletedListener {
        ...
        public void onUtteranceCompleted(String utteranceId) {
            InternalTextToSpeech.this.activity.runOnUiThread(new C04801());
        }
    }
    ...
    private void initializeTts() {
        if (this.tts == null) {
            ...
            this.tts = new TextToSpeech(this.activity, new C04791());
        }
    }
    ...
    private void speak(final String message, final Locale loc, final int retries) {
        ...
        if (this.isTtsInitialized) {
            ...
            this.tts.setOnUtteranceCompletedListener(new C04812());
