...
public final class ErrorMessages {
    ...
    public static final int ERROR_GOOGLE_MAP_INVALID_STYLE_JSON = 12022;
    public static final int ERROR_GOOGLE_MAP_INVALID_THEME = 12021;
    ...
    public static final int ERROR_GOOGLE_MAP_POLYLINE_NOT_EXIST = 12020;
    public static final int ERROR_GOOGLE_MAP_PROPERTY_NOT_EXIST = 12019;
    ...
    static {
        ...
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_PLAY_NOT_INSTALLED), "Google Play is not installed/available on this phone");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_PLAY_SERVICE_UPDATE_REQUIRED), "Google Play Service needs update to newest version");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_NOT_INSTALLED), "Google Map is not installed on this phone");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_INVALID_INPUT), "Invalid input: %s");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_MARKER_NOT_EXIST), "Marker with id: %s does not exist");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_JSON_FORMAT_DECODE_FAILED), "Unable to decode the JSON text: %s");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_CIRCLE_NOT_EXIST), "Circle with id: %s does not exist");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_PLAY_DISABLED), "The installed version of Google Play services has been disabled on this device.");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_PLAY_INVALID), "The version of the Google Play services installed on this device is not authentic.");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_PROPERTY_NOT_EXIST), "Circle with property: %s does not exist");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_INVALID_THEME), "\"%s\"is a invalid Google Map theme. The choices are \"standard\"(default), \"silver\", \"retro\", \"dark\", \"night\", and \"aubergine\".");
        errorMessages.put(Integer.valueOf(ERROR_GOOGLE_MAP_INVALID_STYLE_JSON), "Invalid Google Map style json: %s");
