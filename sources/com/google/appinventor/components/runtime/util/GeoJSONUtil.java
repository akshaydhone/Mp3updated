...
public final class GeoJSONUtil {
    ...
    static class C06381 implements PropertyApplication {
        C06381() {
        }
    ...
    static class C06392 implements PropertyApplication {
        C06392() {
        }
    ...
    static class C06403 implements PropertyApplication {
        C06403() {
        }
    ...
    static class C06414 implements PropertyApplication {
        C06414() {
        }
    ...
    static class C06425 implements PropertyApplication {
        C06425() {
        }
    ...
    static class C06436 implements PropertyApplication {
        C06436() {
        }
    ...
    static class C06447 implements PropertyApplication {
        C06447() {
        }
    ...
    static class C06458 implements PropertyApplication {
        C06458() {
        }
    ...
    static class C06469 implements PropertyApplication {
        C06469() {
        }
    ...
    private static final class FeatureWriter implements MapFeatureVisitor<Void> {
        ...
        private void writeProperties(MapFeature feature) {
            ...
            writeProperty("title", feature.Title());
        ...
        public Void visit(MapMarker marker, Object... arguments) {
            ...
            writeProperty("height", Integer.valueOf(marker.Height()));
            writeProperty(GeoJSONUtil.PROPERTY_IMAGE, marker.ImageAsset());
            writeProperty("width", Integer.valueOf(marker.Width()));
            this.out.print("}}");
            return null;
        }
    ...
    static {
        ...
        colors.put("red", Integer.valueOf(Component.COLOR_RED));
        colors.put("white", Integer.valueOf(-1));
        colors.put("yellow", Integer.valueOf(Component.COLOR_YELLOW));
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new C06381());
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new C06392());
        SUPPORTED_PROPERTIES.put(PROPERTY_DESCRIPTION, new C06403());
        SUPPORTED_PROPERTIES.put(PROPERTY_DRAGGABLE, new C06414());
        SUPPORTED_PROPERTIES.put(PROPERTY_FILL, new C06425());
        SUPPORTED_PROPERTIES.put("height", new C06436());
        SUPPORTED_PROPERTIES.put(PROPERTY_IMAGE, new C06447());
        SUPPORTED_PROPERTIES.put(PROPERTY_INFOBOX, new C06458());
        SUPPORTED_PROPERTIES.put(PROPERTY_STROKE, new C06469());
