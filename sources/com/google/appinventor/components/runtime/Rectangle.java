...
@SimpleObject
@DesignerComponent(category = ComponentCategory.INTERNAL, description = "Rectangle", version = 1)
public class Rectangle extends PolygonBase implements MapRectangle {
    private static final MapFeatureVisitor<Double> distanceComputation = new C06281();
    ...
    static class C06281 implements MapFeatureVisitor<Double> {
        C06281() {
        }
