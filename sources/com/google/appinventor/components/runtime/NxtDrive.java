...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a LEGO MINDSTORMS NXT robot, with functions that can move and turn the robot.", docUri = "iot/lego.html#nxt-drive", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
