...
public class ReplForm extends Form {
    ...
    class C03802 implements OnMenuItemClickListener {
        C03802() {
        }
    ...
    class C03813 implements OnMenuItemClickListener {
        C03813() {
        }
    ...
    public void addSettingsButton(Menu menu) {
        menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new C03802()).setIcon(17301651);
    }

    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new C03813()).setIcon(17301642);
        }
    }
