...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C04326 implements Runnable {
        ...
        class C04311 implements Runnable {
            ...
            public void run() {
                ...
                for (Status status : C04326.this.replies) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C04311());
            }
        }
    }
    ...
    class C04347 implements Runnable {
        ...
        class C04331 implements Runnable {
            ...
            public void run() {
                ...
                for (User user : C04347.this.friends) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C04331());
            }
        }
    }
    ...
    class C04368 implements Runnable {
        ...
        class C04351 implements Runnable {
            ...
            public void run() {
                ...
                for (DirectMessage message : C04368.this.messages) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C04351());
            }
        }
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C04201());
                    return;
                }
                try {
                    ...
                    Twitter.this.handler.post(new C04212());
                }
            }
        });
    }
    ...
    public void CheckAuthorized() {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C04251());
                }
            }
        });
    }
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Twitter.this.handler.post(new C04271());
                        } catch (TwitterException e) {
    ...
    public void RequestMentions() {
        ...
        AsynchUtil.runAsynchronously(new C04326());
    }
    ...
    public void RequestFollowers() {
        ...
        AsynchUtil.runAsynchronously(new C04347());
    }
    ...
    public void RequestDirectMessages() {
        ...
        AsynchUtil.runAsynchronously(new C04368());
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C04221());
                }
            }
        });
    }
