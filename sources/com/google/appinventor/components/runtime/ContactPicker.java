...
public class ContactPicker extends Picker implements ActivityResultListener {
    ...
    class C06081 implements PermissionResultHandler {
        C06081() {
        }
    ...
    public void click() {
        if (this.havePermission) {
            ...
            this.container.$form().askPermission("android.permission.READ_CONTACTS", new C06081());
        }
    }
