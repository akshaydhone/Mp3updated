...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a LEGO MINDSTORMS EV3 robot, with functions to draw graphs on EV3 screen.", docUri = "iot/lego.html#ev3-ui", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
