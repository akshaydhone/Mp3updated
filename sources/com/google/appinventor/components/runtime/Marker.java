...
public class Marker extends MapFeatureBaseWithFill implements MapMarker {
    ...
    private static final MapFeatureVisitor<Double> bearingComputation = new C06232();
    private static final MapFeatureVisitor<Double> distanceComputation = new C06221();
    ...
    static class C06221 implements MapFeatureVisitor<Double> {
        C06221() {
        }
    ...
    static class C06232 implements MapFeatureVisitor<Double> {
        C06232() {
        }
