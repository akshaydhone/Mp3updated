...
public abstract class ButtonBaseNoText extends AndroidViewComponent implements OnClickListener, OnFocusChangeListener, OnLongClickListener, OnTouchListener {
    ...
    public ButtonBaseNoText(ComponentContainer container) {
        super(container);
    ...
    public ButtonBaseNoText(ComponentContainer container, String togglerButtonOrSwitch) {
        super(container);
        if (togglerButtonOrSwitch.equals("TogglerButton")) {
            this.view = new ToggleButton(container.$context());
        } else if (togglerButtonOrSwitch.equals("ThunkableSwitch")) {
            this.view = new Switch(container.$context());
        } else {
