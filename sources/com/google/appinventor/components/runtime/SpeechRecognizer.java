...
@SimpleObject
@DesignerComponent(category = ComponentCategory.MEDIA, description = "Component for using Voice Recognition to convert from speech to text", docUri = "voice/speech-recognizer", iconName = "images/speechRecognizer.png", nonVisible = true, version = 1)
