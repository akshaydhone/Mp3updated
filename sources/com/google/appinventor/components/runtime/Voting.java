...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C06352 implements AsyncCallbackPair<JSONObject> {
        ...
        public void onSuccess(JSONObject result) {
            if (result == null) {
                Voting.this.androidUIHandler.post(new C04411());
                return;
            }
            try {
                ...
                if (Voting.this.isPolling.booleanValue()) {
                    ...
                    Voting.this.androidUIHandler.post(new C04422());
                    return;
                }
                Voting.this.androidUIHandler.post(new C04433());
            } catch (JSONException e) {
                Voting.this.androidUIHandler.post(new C04444());
            }
        }
    ...
    class C06364 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            Voting.this.androidUIHandler.post(new C04471());
        }
    ...
    public void RequestBallot() {
        AsynchUtil.runAsynchronously(new C04401());
    }
    ...
    public void SendBallot() {
        AsynchUtil.runAsynchronously(new C04463());
    }
