...
@SimpleObject
@DesignerComponent(category = ComponentCategory.INTERNAL, description = "Polygon", version = 1)
public class Polygon extends PolygonBase implements MapPolygon {
    ...
    private static final MapFeatureVisitor<Double> distanceComputation = new C06271();
    ...
    static class C06271 implements MapFeatureVisitor<Double> {
        C06271() {
        }
