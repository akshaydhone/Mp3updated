...
@SimpleObject
@DesignerComponent(category = ComponentCategory.INTERNAL, description = "LineString", version = 1)
public class LineString extends MapFeatureBase implements MapLineString {
    ...
    private static final MapFeatureVisitor<Double> distanceComputation = new C06181();
    private List<GeoPoint> points = new ArrayList();

    /* renamed from: com.google.appinventor.components.runtime.LineString$1 */
    static class C06181 implements MapFeatureVisitor<Double> {
        C06181() {
        }
