...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C07001();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C07012();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05853();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C05853 implements ViewPropertyAnimatorUpdateListener {
        C05853() {
        }
    ...
    class C07001 extends ViewPropertyAnimatorListenerAdapter {
        C07001() {
        }
    ...
    class C07012 extends ViewPropertyAnimatorListenerAdapter {
        C07012() {
        }
