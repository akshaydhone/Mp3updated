...
class AdvertisingInfoServiceStrategy implements AdvertisingInfoStrategy {
    ...
    private static final class AdvertisingConnection implements ServiceConnection {
        ...
        public IBinder getBinder() {
            if (this.retrieved) {
                Fabric.getLogger().mo1331e(Fabric.TAG, "getBinder already called");
            }
            this.retrieved = true;
            try {
    ...
    private static final class AdvertisingInterface implements IInterface {
        ...
        public String getId() throws RemoteException {
            ...
            try {
                ...
                Fabric.getLogger().mo1329d(Fabric.TAG, "Could not get parcel from Google Play Service to capture AdvertisingId");
            } finally {
                reply.recycle();
                data.recycle();
            }
        ...
        L_0x002e:
            ...
            r4.mo1329d(r5, r6);	 Catch:{ all -> 0x0041 }
            r3.recycle();
            r0.recycle();
            goto L_0x002b;
        L_0x0041:
    ...
    public AdvertisingInfo getAdvertisingInfo() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            Fabric.getLogger().mo1329d(Fabric.TAG, "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            ...
            try {
                ...
                Fabric.getLogger().mo1329d(Fabric.TAG, "Could not bind to Google Play Service to capture AdvertisingId");
                return null;
            } catch (Exception e) {
                Fabric.getLogger().mo1343w(Fabric.TAG, "Exception in binding to Google Play Service to capture AdvertisingId", e);
                this.context.unbindService(connection);
                return null;
            } catch (Throwable t) {
                Fabric.getLogger().mo1330d(Fabric.TAG, "Could not bind to Google Play Service to capture AdvertisingId", t);
                return null;
            }
        } catch (NameNotFoundException e2) {
            Fabric.getLogger().mo1329d(Fabric.TAG, "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e3) {
            Fabric.getLogger().mo1330d(Fabric.TAG, "Unable to determine if Google Play Services is available", e3);
            return null;
        }
    }
}
