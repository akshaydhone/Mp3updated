...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C05151();
    ...
    private final WorkerRunnable<Params, Result> worker = new C06612();

    /* renamed from: io.fabric.sdk.android.services.concurrency.AsyncTask$1 */
    static class C05151 implements ThreadFactory {
    ...
    class C06612 extends WorkerRunnable<Params, Result> {
        C06612() {
            super();
        }
