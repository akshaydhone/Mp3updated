...
public final class MultipartBody extends RequestBody {
    ...
    private static final byte[] COLONSPACE = new byte[]{Opcode.MOVE32_32, (byte) 32};
    private static final byte[] CRLF = new byte[]{(byte) 13, (byte) 10};
    private static final byte[] DASHDASH = new byte[]{Opcode.RL16, Opcode.RL16};
    ...
    public static final class Part {
        ...
        public static Part createFormData(String name, @Nullable String filename, RequestBody body) {
            ...
            return create(Headers.of(MIME.CONTENT_DISPOSITION, disposition.toString()), body);
        }
