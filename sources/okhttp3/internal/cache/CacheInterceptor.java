...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers cachedHeaders, Headers networkHeaders) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (!(org.apache.http.HttpHeaders.WARNING.equalsIgnoreCase(fieldName) && value.startsWith("1")) && (!isEndToEnd(fieldName) || networkHeaders.get(fieldName) == null)) {
    ...
    static boolean isEndToEnd(String fieldName) {
        if ("Connection".equalsIgnoreCase(fieldName) || HTTP.CONN_KEEP_ALIVE.equalsIgnoreCase(fieldName) || org.apache.http.HttpHeaders.PROXY_AUTHENTICATE.equalsIgnoreCase(fieldName) || "Proxy-Authorization".equalsIgnoreCase(fieldName) || org.apache.http.HttpHeaders.TE.equalsIgnoreCase(fieldName) || "Trailers".equalsIgnoreCase(fieldName) || "Transfer-Encoding".equalsIgnoreCase(fieldName) || org.apache.http.HttpHeaders.UPGRADE.equalsIgnoreCase(fieldName)) {
            return false;
        }
        return true;
    }
