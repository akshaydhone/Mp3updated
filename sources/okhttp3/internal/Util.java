...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C05381();
    ...
    class C05381 implements Comparator<String> {
        C05381() {
        }
    ...
    class C05392 implements ThreadFactory {
        final /* synthetic */ boolean val$daemon;
        final /* synthetic */ String val$name;

        C05392(String str, boolean z) {
            this.val$name = str;
            this.val$daemon = z;
        }
