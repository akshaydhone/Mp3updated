...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (this.end - this.beg > 4 && this.chars[this.beg + 3] == '.' && ((this.chars[this.beg] == 'O' || this.chars[this.beg] == 'o') && ((this.chars[this.beg + 1] == Access.INNERCLASS_CONTEXT || this.chars[this.beg + 1] == 'i') && (this.chars[this.beg + 2] == 'D' || this.chars[this.beg + 2] == 'd')))) {
            this.beg += 4;
        }
    ...
    private String hexAV() {
        ...
        while (this.pos != this.length && this.chars[this.pos] != '+' && this.chars[this.pos] != ',' && this.chars[this.pos] != ';') {
            ...
            if (this.chars[this.pos] >= 'A' && this.chars[this.pos] <= Access.FIELD_CONTEXT) {
    ...
    private char getUTF8() {
        ...
        if (res < FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE || res > 247) {
            return '?';
        }
        int count;
        if (res <= 223) {
