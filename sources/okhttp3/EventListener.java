...
public abstract class EventListener {
    public static final EventListener NONE = new C06681();
    ...
    class C06681 extends EventListener {
        C06681() {
        }
    }

    /* renamed from: okhttp3.EventListener$2 */
    class C06692 implements Factory {
        final /* synthetic */ EventListener val$listener;

        C06692(EventListener eventListener) {
