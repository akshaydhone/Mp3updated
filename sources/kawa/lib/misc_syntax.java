...
public class misc_syntax extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f108p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f107k, x), lambda4f());
            }
            ports.closeInputPort(this.f108p);
            return LList.Empty;
        }
    }
    ...
    static Object lambda3(Object x) {
        ...
        frame.f107k = execute;
        try {
            frame.f108p = ports.openInputFile(Path.valueOf(fn));
